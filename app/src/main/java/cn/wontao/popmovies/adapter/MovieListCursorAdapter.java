 ...
 */
public class MovieListCursorAdapter extends CursorRecyclerViewAdapter<MovieListCursorAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, Cursor cursor, int position) {
        map.put(position, cursor.getString(MainFragment.COL_MOVIE_ID));
